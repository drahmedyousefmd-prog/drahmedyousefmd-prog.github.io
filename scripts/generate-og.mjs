...
const NAME = "Rochetta";
const TAGLINE_AR = "دليلك العملي للروشتات الطبية";
const TAGLINE_EN = "Your Practical Medical Prescription Guide";
...
async function main() {
  ...
  const el = col(
    [
      ...
      row(NAME, { fontSize: 72, fontWeight: 700, color: "#143f3a", marginTop: 28 }),
      row(TAGLINE_AR, { fontSize: 34, fontWeight: 700, color: "#1f5b54", marginTop: 14 }),
      row(TAGLINE_EN, {
        fontSize: 20,
        color: "#68736d",
        letterSpacing: 3,
